  ...
  return (
    ...
    >
      ...
      <button
        ...
        title="Center Canvas"
        className="w-20 h-16 flex flex-col items-center justify-center p-2 rounded-lg transition-all duration-200 text-xs font-medium focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 bg-gray-200 text-[#525252] hover:bg-gray-300"
      >
          ...
          className={`w-20 h-16 flex flex-col items-center justify-center p-2 rounded-lg transition-all duration-200 text-xs font-medium focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2
            ${
              visibility[key]
                ...
                : "bg-gray-200 text-[#525252] hover:bg-gray-300"
            }
          `}
        >
