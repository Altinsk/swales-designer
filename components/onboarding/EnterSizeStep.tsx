...
const EnterSizeStep: React.FC<EnterSizeStepProps> = ({ onPositionPlot }) => {
  ...
  return (
    <div>
      <p className="text-[#525252] mt-1 mb-6">
        Enter the size of your plot (length * width)
      </p>
      <form onSubmit={handleSubmit} className="flex flex-col items-center">
        <div className="flex flex-col md:flex-row items-center gap-8 mb-8">
          <div className="w-48 h-25 m-4  rounded-md flex items-center justify-center text-[#a3a3a3]">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-2">
              <label
                htmlFor="length"
                className="font-semibold text-[#404040] w-16"
              >
                Length
              </label>
              <input
              ...
              />
              <span className="text-[#737373]">m</span>
            </div>
            <div className="flex items-center gap-2">
              <label
                htmlFor="width"
