...
const NewDrawingWarningStep: React.FC<NewDrawingWarningStepProps> = ({
  ...
  return (
    <div>
      <p className="text-[#525252] my-4 text-lg">
        Do you want to save your existing garden before you start a new plan?
      </p>
      <div className="mt-8 flex justify-end items-center gap-4">
        <button
          onClick={onDiscard}
          className="px-6 py-2 rounded-full text-[#404040] border border-gray-300 hover:bg-gray-100 transition-colors font-semibold"
        >
          Discard
        </button>
        <button
